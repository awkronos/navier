...
The read-only audit examined 674 reachable native commits and 1,806 blobs,
based on main `4e4aab7baac891c0e63ba80fa90f695e1da46787` and the locally
available ref set. It found no credential-signature candidates, suspicious
credential filenames, or blobs at least 1 MiB. This is a bounded signature and
path audit, not a guarantee that every possible secret format is detectable.
Current tracked numerical artifacts and compiler receipts are intentional
research evidence.

All 577 adapted construction modules carry the pinned upstream revision,
