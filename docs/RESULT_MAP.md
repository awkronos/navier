...
| Strong evolving time derivative | [CriticalMildTimeJetInterchange](../Navier/Analysis/CriticalMildTimeJetInterchange.lean), [CriticalMildSecondTimeDerivative](../Navier/Analysis/CriticalMildSecondTimeDerivative.lean), [CriticalMildTimeJetMoments](../Navier/Analysis/CriticalMildTimeJetMoments.lean) | Constructs the actual first derivative in the completed weighted Fourier carrier and every mode's second time derivative. Exact derivative-carrier moment transport and the differentiated two-slot convolution bound provide reusable higher-jet estimates. The second completed-carrier derivative, all-order time induction and joint classical reconstruction remain to be constructed. |
