...
| Endpoint-as-assumption | Normalize all hypotheses and compare with the conclusion/continuation criterion | Serrin, \(L^\infty_tL^3_x\), BKM-type, or strain criterion simply assumed | Move the assumed bound into the open-residual field | F-003, F-011, F-022, F-023 |
