...
Upstream source: NavierStokes/ActualSignedCoherence.lean
...
namespace Navier.Construction.ActualSignedCoherence
...
theorem exactBlock_pressure_transport (l : SignedLabel B N0) (u : CorrectionState.State Point)
  ...
  simp only [Complex.real_smul, Complex.mul_re, Complex.mul_im,
    Complex.ofReal_re, Complex.ofReal_im, zero_mul, sub_zero]
  ring
end Navier.Construction.ActualSignedCoherence
