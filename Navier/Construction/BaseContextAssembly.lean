...
Upstream source: NavierStokes/BaseContextAssembly.lean
...
import Navier.Construction.PhysicalResidualTZ
import Navier.Construction.PrimaryTargetBounds
import Navier.Construction.AllBandBaseJets
...
namespace Navier.Construction.BaseContextAssembly
...
theorem leadingVirtualStress_eq (n : ℕ) {x : Point} (hT : 0 < x.2.1.1) (hR : 0 < x.1) :
  ...
  rw [leadingVirtualStress, if_pos hR]
  congr 1
...
end Navier.Construction.BaseContextAssembly
