...
Upstream source: NavierStokes/SimilarityCoordinates.lean
...
namespace Navier.Construction.SimilarityCoordinates
...
theorem coordinateQ_spec {a : ℝ} (ha : 0 < a) (ha1 : a < 1)
  ...
  simp only [coordinateQ, dif_pos (show 0 < a ∧ a < 1 ∧ 0 < p.1 from ⟨ha, ha1, hp⟩)]
...
end Navier.Construction.SimilarityCoordinates
