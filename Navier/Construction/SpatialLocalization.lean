...
Upstream source: NavierStokes/SpatialLocalization.lean
...
-/
import Navier.Construction.PeriodicLocalization
import Navier.Construction.SolenoidalDiagonal
import Navier.Construction.CylindricalResidual
import Navier.Construction.ResidualRegularity
import Navier.Construction.TimeLocalization
...
namespace Navier.Construction.SpatialLocalization
...
theorem isCompact_supportCylinder : IsCompact supportCylinder := by
  ...
  ext x
  simp only [supportCylinder, Set.mem_setOf_eq, AxisymmetricFields.radialEnergy, radialSquare]
...
end Navier.Construction.SpatialLocalization
