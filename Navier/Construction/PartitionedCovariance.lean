...
Upstream source: NavierStokes/PartitionedCovariance.lean
...
-/
import Navier.Construction.SquaredPartition
import Navier.Construction.TorusAverages
import Navier.Construction.PhaseCalculus
import Navier.Construction.ParametricODE
import Navier.Construction.PhaseEstimates
...
namespace Navier.Construction.PartitionedCovariance
...
noncomputable def tangentExtension {r a A b B c₀ s₀ slope E : ℝ}
  ...
  ParametricODE.extend (sq_nonneg r)
    ⟨fun v => P.tangent v, continuous_pi fun i => (P.tangent_continuous i).restrict⟩
...
end Navier.Construction.PartitionedCovariance
