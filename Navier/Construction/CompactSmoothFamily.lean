...
Upstream source: NavierStokes/CompactSmoothFamily.lean
...
namespace Navier.Construction.CompactSmoothFamily
...
theorem family_apply (K : Set Z) (F : P × Z → E) (p : P)
  ...
  simp only [family, dif_pos hp, ContinuousMap.coe_mk]
...
end Navier.Construction.CompactSmoothFamily
