...
Upstream source: NavierStokes/PositiveAxisExistence.lean
...
-/
import Navier.Construction.VolterraRegularity
import Navier.Construction.ParametricEvenDescent
import Navier.Construction.PositiveAxisSystem
...
namespace Navier.Construction.PositiveAxisExistence
...
theorem matrixPath_shape {R : ℝ} (hR : 0 ≤ R) {A : Coeff}
  ...
  · simp only [symmetricRawCoefficient, matrixPath, CompactSmoothFamily.family,
      dif_pos hc, ContinuousMap.coe_mk, matrixOperator_toMatrix]
...
end Navier.Construction.PositiveAxisExistence
