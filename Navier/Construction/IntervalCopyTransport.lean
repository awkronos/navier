...
Upstream source: NavierStokes/IntervalCopyTransport.lean
...
namespace Navier.Construction.IntervalCopyTransport
...
theorem anchoredSolve_unique (d : LinearData P V E) (g : Geometry)
  ...
  apply TangentODE.linear_solution_unique hab
    ...
    (continuousOn_iff_continuous_restrict.mpr hA) hu
...
end Navier.Construction.IntervalCopyTransport
