...
Upstream source: NavierStokes/SmoothPathFamily.lean
...
namespace Navier.Construction.SmoothPathFamily
...
theorem pathFamily_apply (F : P × ℝ → E) (p : P)
  ...
  simp only [pathFamily, dif_pos hp, ContinuousMap.coe_mk]
...
end Navier.Construction.SmoothPathFamily
