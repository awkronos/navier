...
Upstream source: NavierStokes/ActualCopySliceRegularity.lean
...
namespace Navier.Construction.ActualCopySliceRegularity
...
theorem frame_slices (F : PhaseConstruction D) (i : ι) (j : ℤ)
  ...
  exact ⟨(PrimaryCopyBridge.projectedOperator_continuousOn hn hnd hA hδ hne).restrict,
    (negativeProjection_continuousOn hn hne).restrict⟩
...
end Navier.Construction.ActualCopySliceRegularity
