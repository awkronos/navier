...
Upstream source: NavierStokes/TemporalMeanUpdate.lean
...
import Navier.Construction.SmoothFamilyTorusInverse
import Navier.Construction.PressureStream
import Navier.Construction.ChartScales
import Navier.Construction.TorusAverages
import Navier.Construction.UniformFourierAlias
...
namespace Navier.Construction.TemporalMeanUpdate
...
private theorem nat_le_smooth (n : ℕ) : (n : WithTop ℕ∞) ≤ ∞ :=
  le_of_lt (WithTop.coe_lt_coe.mpr (ENat.coe_lt_top n))
...
end Navier.Construction.TemporalMeanUpdate
