...
Upstream source: NavierStokes/BaseResidual.lean
...
import Navier.Construction.NaturalCore
import Navier.Construction.DiagonalResidual
...
import Navier.Construction.ActiveAnnulusWeight
import Navier.Construction.AxisTailRegularity
import Navier.Construction.SlowFirstOrderEdge
...
namespace Navier.Construction.BaseResidual
...
theorem slowSum_split_first {a : ℕ → ℕ} (ha : StrictMono a) (h : ℝ)
  ...
  have he (j : ℕ) : slowStage a h f j (q, w) =
    ...
    · rw [slowStage_eq hj0, slowStage_eq hj0, if_neg hj1, zero_add]
...
end Navier.Construction.BaseResidual
