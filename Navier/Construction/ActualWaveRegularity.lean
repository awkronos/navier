...
Upstream source: NavierStokes/ActualWaveRegularity.lean
...
namespace Navier.Construction.ActualWaveRegularity
...
theorem periodic : CorrectionStep.OscillationPeriodic U.carrier (modeOscillation a s d e) := by
  ...
  have hx : e ((R, (t, Y)), θ) ∈ nativeDomain e U := by
    simpa only [nativeDomain, mem_preimage, e.symm_apply_apply, fullDomain,
      ...
      PhysicalMeanDomain.slowDomain, Set.mem_setOf_eq] using ht
...
end Navier.Construction.ActualWaveRegularity
