...
Upstream source: NavierStokes/ActualSignedFamilySupport.lean
...
namespace Navier.Construction.ActualSignedFamilySupport
...
private theorem gate_copyAt {H : ℕ} {K : Type*}
  ...
  · simp only [DependentSignedPhysicalFamily.Family.copyAt, dif_pos hL]
  · simp only [DependentSignedPhysicalFamily.Family.copyAt, dif_neg hL, gate_zeroCopies]
...
theorem potential_source_domain (i : Fin 3) (k : TorusInverse.Frequency)
  ...
  · simp only [DependentSignedPhysicalFamily.Family.copyAt, dif_pos hI] at hne
  ...
  · exact (hne (by simp only [DependentSignedPhysicalFamily.Family.copyAt, dif_neg hI,
...
end Navier.Construction.ActualSignedFamilySupport
