...
Upstream source: NavierStokes/CommonCoverSolve.lean
...
import Navier.Construction.SmoothPathFamily
import Navier.Construction.JointODE
import Navier.Construction.WeightedODEJets
...
namespace Navier.Construction.CommonCoverSolve
...
theorem pathFamily_congr_slice {Q W : Type} [NormedAddCommGroup Q] [NormedSpace ℝ Q]
  ...
  · have hG : ¬ Continuous (fun t : Icc a b => G (q, t)) := by
    ...
    simp only [SmoothPathFamily.pathFamily, dif_neg hF, dif_neg hG]
...
end Navier.Construction.CommonCoverSolve
