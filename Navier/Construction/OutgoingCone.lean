...
Upstream source: NavierStokes/OutgoingCone.lean
...
-/
import Navier.Construction.OutgoingEntranceCone
import Navier.Construction.ShapedWaitBounds
import Navier.Construction.PulseCone
import Navier.Construction.TailCone
import Navier.Construction.OutgoingProfile
...
open Navier.Construction.OutgoingSchedule Navier.Construction.OutgoingTail
open Navier.Construction.UniformAngularReset (ResetWitness)
open Navier.Construction.OutgoingEntranceCone (coneA coneB coneRatio)

namespace Navier.Construction.OutgoingCone
...
end Navier.Construction.OutgoingCone
