...
Upstream source: NavierStokes/LoopVariance.lean
...
-/
import Navier.Construction.SmoothLoop
...
namespace Navier.Construction.LoopVariance
...
theorem regularizedTilt_eq_extended (m d μ p θ : ℝ) :
  ...
  · simp only [extendedExpTilt, if_neg hp, regularizedTilt, expTilt]
...
end Navier.Construction.LoopVariance
