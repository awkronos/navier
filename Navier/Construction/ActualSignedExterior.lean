...
Upstream source: NavierStokes/ActualSignedExterior.lean
...
import Navier.Construction.DependentSignedPhysicalFamily
...
namespace Navier.Construction.ActualSignedExterior
...
theorem potential_gap (i : Fin 3) (L : BandLabel) :
  ...
  · simp only [DependentSignedPhysicalFamily.Family.copyAt, dif_pos hL]
    rfl
  · simp only [DependentSignedPhysicalFamily.Family.copyAt, dif_neg hL]
    rfl
...
end Navier.Construction.ActualSignedExterior
