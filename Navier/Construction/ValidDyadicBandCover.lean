...
Upstream source: NavierStokes/ValidDyadicBandCover.lean
...
import Navier.Construction.MixedDiagonalExtensions
import Navier.Construction.ValidBandGluing
...
namespace Navier.Construction.ValidDyadicBandCover
...
theorem mem_band_iff {h : ℝ} {n : ℕ} {w : SpaceTime} :
  ...
  simp only [band, Set.mem_setOf_eq, mem_Ioo, lt_div_iff₀ hQ, div_lt_iff₀ hQ]
...
end Navier.Construction.ValidDyadicBandCover
