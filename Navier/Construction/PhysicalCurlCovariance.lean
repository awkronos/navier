...
Upstream source: NavierStokes/PhysicalCurlCovariance.lean
...
import Navier.Construction.SpatialCurl
...
namespace Navier.Construction.PhysicalCurlCovariance
...
theorem globalCartesianPotential_eq_local {a : ℝ} (ha : 0 < a)
  ...
  rw [globalCartesianPotential, dif_pos he]
...
end Navier.Construction.PhysicalCurlCovariance
