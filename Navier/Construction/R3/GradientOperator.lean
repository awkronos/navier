...
Upstream source: NavierStokes/R3/GradientOperator.lean
...
namespace Navier.ConstructionR3.GradientOperator
...
theorem continuous_gradientSq {w : Space → Space} (hw : ContDiff ℝ 1 w) :
  ...
  exact continuous_finsetSum _ fun i _ =>
    (Navier.Construction.PeriodicIntegration.continuous_partial hw i).norm.pow 2

end Navier.ConstructionR3.GradientOperator
