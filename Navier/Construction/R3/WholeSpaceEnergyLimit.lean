...
Upstream source: NavierStokes/R3/WholeSpaceEnergyLimit.lean
...
namespace Navier.ConstructionR3.WholeSpaceEnergyLimit
...
theorem eq_zero_of_weighted_rate_bound {w : VelocityField} {T K C R₀ : ℝ}
  ...
  intro t ht
  have hs := Navier.Construction.PeriodicUniqueness.spatial_smooth hw ht
...
end Navier.ConstructionR3.WholeSpaceEnergyLimit
