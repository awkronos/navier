...
Upstream source: NavierStokes/R3/PressureTestBounds.lean
...
-/
import Navier.Construction.R3.SchwartzParseval
import Navier.Construction.R3.FourierTestDerivatives
import Navier.Construction.R3.FourierSobolevWeights
...
namespace Navier.ConstructionR3.PressureTestBounds
...
theorem integrable_inverse_weight_sq :
  ...
  have h := integrable_rpow_neg_one_add_norm_sq
    (μ := (volume : Measure Space)) (r := 4) (by norm_num [Space,
      Navier.Construction.ProblemStatement.Space])
  convert! h using 1
  ext ξ
  norm_num
...
end Navier.ConstructionR3.PressureTestBounds
