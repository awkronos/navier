...
Upstream source: NavierStokes/R3/PressureFlux.lean
...
-/
import Navier.Construction.R3.PressureFluxTest
import Navier.Construction.R3.PressureRecoveryHelpers
import Navier.Construction.R3.RieszTestOperators
import Navier.Construction.R3.LocalizedTensorBounds
import Navier.Construction.R3.ActualPressureFlux
import Navier.Construction.R3.HeatKernelCommutator
...
namespace Navier.ConstructionR3.PressureFlux
...
theorem exists_uniform_actual_pressure_flux_bound {T : ℝ} {u v : VelocityField}
  ...
  have hu := Navier.Construction.PeriodicUniqueness.spatial_smooth H.smooth_u ht'
  have hv := Navier.Construction.PeriodicUniqueness.spatial_smooth H.smooth_v ht'
...
end Navier.ConstructionR3.PressureFlux
