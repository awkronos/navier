...
Upstream source: NavierStokes/R3/WholeSpaceComparisonClosure.lean
...
-/
import Navier.Construction.R3.WholeSpaceEnergyLimit
import Navier.Construction.R3.LocalizedFluxEstimates
import Navier.Construction.R3.ComparisonRateBound
...
namespace Navier.ConstructionR3.WholeSpaceComparisonClosure

open ProblemStatement Comparison ComparisonCutoffs
open Navier.Construction.ProblemStatement (spatialDerivative spatialDivergence)
open Navier.Construction.PeriodicUniqueness (spatial_smooth time_differentiable_at_interior)
...
end Navier.ConstructionR3.WholeSpaceComparisonClosure
