...
Upstream source: NavierStokes/R3/WeightedSobolev.lean
...
import Navier.Construction.R3.GradientOperator
import Navier.Construction.R3.WeightedInterpolation
...
namespace Navier.ConstructionR3.WeightedSobolev
...
theorem lpNorm_six_le {E : Type*} [NormedAddCommGroup E]
  ...
  have hn : Module.finrank ℝ Space = 3 := by simp [Space, Navier.Construction.ProblemStatement.Space]
...
end Navier.ConstructionR3.WeightedSobolev
