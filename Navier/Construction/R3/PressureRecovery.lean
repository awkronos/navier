...
Upstream source: NavierStokes/R3/PressureRecovery.lean
...
import Navier.Construction.R3.ComparisonTimeAverages
import Navier.Construction.R3.WeakTimeContinuity
import Navier.Construction.R3.TemporalTestUniqueness
import Navier.Construction.R3.HarmonicTestFunctionals
...
namespace Navier.ConstructionR3.PressureRecovery

open Navier.Construction.ProblemStatement
open Navier.Construction.PeriodicIntegration (spatialPartial)
open Navier.Construction.PeriodicUniqueness
...
structure Hypotheses (T : ℝ) (u v : VelocityField) (p q : PressureField) : Prop where
  ...
  energy_u : Navier.ConstructionR3.ProblemStatement.UniformFiniteEnergy (Icc 0 T) u
  energy_v : Navier.ConstructionR3.ProblemStatement.UniformFiniteEnergy (Icc 0 T) v
...
theorem pressure_gradient_recovery {T t : ℝ} {u v : VelocityField} {p q : PressureField}
    ...
    (heu : Navier.ConstructionR3.ProblemStatement.UniformFiniteEnergy (Icc 0 T) u)
...
end Navier.ConstructionR3.PressureRecovery
