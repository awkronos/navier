...
Upstream source: NavierStokes/R3/ComparisonCutoffs.lean
...
namespace Navier.ConstructionR3.ComparisonCutoffs

open ProblemStatement
open Navier.Construction.ProblemStatement (coordinateVector)
...
theorem norm_partial_partial_le {f : Space → ℝ} (hf : ContDiff ℝ ∞ f)
    (i j : Fin 3) (x : Space) :
    ‖Navier.Construction.PeriodicIntegration.spatialPartial i
      (Navier.Construction.PeriodicIntegration.spatialPartial j f) x‖ ≤
...
theorem cutoff_partial_partial_le {R : ℝ} (hR : 0 < R) (i j : Fin 3) (x : Space) :
    ‖Navier.Construction.PeriodicIntegration.spatialPartial i
      (Navier.Construction.PeriodicIntegration.spatialPartial j (cutoff R)) x‖ ≤
...
theorem cutoff_laplacian_le {R : ℝ} (hR : 0 < R) (x : Space) :
  ...
  calc
    ‖laplacian (cutoff R) x‖
        ≤ ∑ i : Fin 3, ‖Navier.Construction.PeriodicIntegration.spatialPartial i
          (Navier.Construction.PeriodicIntegration.spatialPartial i (cutoff R)) x‖ :=
      norm_sum_le _ _
...
end Navier.ConstructionR3.ComparisonCutoffs
