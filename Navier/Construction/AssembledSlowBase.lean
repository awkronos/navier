...
Upstream source: NavierStokes/AssembledSlowBase.lean
...
-/
import Navier.Construction.GlobalSlowProfiles
...
import Navier.Construction.NaturalCoefficientBridge
...
namespace Navier.Construction.AssembledSlowBase
...
theorem thetaEven_eq (Z0 : ZeroOrderSolved s inner) (n : ℕ) {R eta : ℝ}
  ...
  simp only [SlowStressSupport.stress, if_neg (by linarith : ¬0 < -R), add_zero]
...
end Navier.Construction.AssembledSlowBase
