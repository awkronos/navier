...
Upstream source: NavierStokes/NominalConeAssembly.lean
...
import Navier.Construction.MatchingDebtBounds
import Navier.Construction.OutgoingCone
import Navier.Construction.HeatSwitchCone
import Navier.Construction.TerminalHistoryBridge
import Navier.Construction.TrueConeLoop
import Navier.Construction.ModulatedCone
import Navier.Construction.MatchingConeBounds
import Navier.Construction.PreparedOutgoing
import Navier.Construction.RepairConeBounds
...
open Navier.Construction.ProfileHistories
open Navier.Construction.OutgoingProfile
open Navier.Construction.NominalProfile (AxisStage Controls SmallDebt)
open Navier.Construction.StressActivation

namespace Navier.Construction.NominalConeAssembly
...
theorem prefix_f {p : Point} (hp : p.1 ≤ W.controls.heatJoin) :
  ...
  · simp only [Controls.extendedf, if_pos hXi]
  · rw [Controls.extendedf, if_neg hXi,
      W.controls.extendedE_before W.heat.coefficients hp, Controls.f, if_neg hXi]
...
end Navier.Construction.NominalConeAssembly
