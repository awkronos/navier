...
Upstream source: NavierStokes/PositiveTimeSignedData.lean
...
import Navier.Construction.PositiveTimeSignedLocalization
...
namespace Navier.Construction.PositiveTimeSignedData
  ...
  angular_integer k L := by
    ...
    · refine ⟨(G.angular ⟨L.val, L.property, hL⟩).mode, ?_⟩
      simpa only [potentialCopies, PositiveTimeCopyFamily.gate,
        ActualSignedPhysicalData.potentialFamily, extendedCarrier, dif_pos hL] using
  ...
  angular_integer k L := by
    ...
    · refine ⟨(G.angular ⟨L.val, L.property, hL⟩).mode, ?_⟩
      simpa only [pressureCopies, PositiveTimeCopyFamily.gate,
        ActualSignedPhysicalData.pressureFamily, extendedCarrier, dif_pos hL] using
        angular_integer sys f G ⟨L.val, L.property, hL⟩ k
...
end Navier.Construction.PositiveTimeSignedData
