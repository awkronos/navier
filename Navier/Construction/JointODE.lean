...
Upstream source: NavierStokes/JointODE.lean
...
namespace Navier.Construction.JointODE
...
theorem reparamSolution_eq_actualSolution (hab : a ≤ b) {U : Set P}
  ...
  have hBc : Continuous (fun s : Icc (0 : ℝ) 1 => rescale a A (z, s)) := hB.restrict
  have hgc : Continuous (fun s : Icc (0 : ℝ) 1 => rescale a f (z, s)) := hg.restrict
...
end Navier.Construction.JointODE
