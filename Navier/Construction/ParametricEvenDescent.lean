...
Upstream source: NavierStokes/ParametricEvenDescent.lean
...
namespace Navier.Construction.ParametricEvenDescent
...
theorem localized_eventually_zero_parameter {a A R : ℝ} (hA : 0 < A)
  ...
  have h := (cutoff_eventually_zero hA hq).comp_tendsto
    ((continuous_fst.sub continuous_const).tendsto q)
...
end Navier.Construction.ParametricEvenDescent
