...
Upstream source: NavierStokes/CopyAngularInvariance.lean
...
namespace Navier.Construction.CopyAngularInvariance
...
theorem TangentInvariant.copySolve_invariant {θ : P} {d : TangentData P H} (h : TangentInvariant θ d)
  ...
  Navier.Construction.CopyAngularInvariance.copySolve_invariant d.linearData g hab θ
...
end Navier.Construction.CopyAngularInvariance
