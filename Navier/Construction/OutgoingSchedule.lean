...
Upstream source: NavierStokes/OutgoingSchedule.lean
...
import Navier.Construction.LocalizedMomentRepair
...
namespace Navier.Construction.OutgoingSchedule
...
theorem dropCoefficient_bounds (m y : ℝ) :
  ...
  · have hlo := sigma_nonneg (Real.log y / m)
    ...
    simp only [dropCoefficient, if_neg hy]
...
end Navier.Construction.OutgoingSchedule
