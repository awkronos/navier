...
Upstream source: NavierStokes/JointResidualLimits.lean
...
namespace Navier.Construction.JointResidualLimits
...
theorem boundaryLimits_joint {f : SpaceTime → V} (hzero : VanishingJointJets f)
  ...
  · simp only [boundaryLimits, dif_neg hx]
...
end Navier.Construction.JointResidualLimits
