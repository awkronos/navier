...
Upstream source: NavierStokes/ActualCandidateAssembly.lean
...
-/
import Navier.Construction.ActualCandidateConstruction
import Navier.Construction.InitialPhysicalData
import Navier.Construction.ActualPhysicalStageBounds
import Navier.Construction.GermCandidateAssembly
import Navier.Construction.ActualValidBandWaves
import Navier.Construction.ActualMeanExterior
import Navier.Construction.ActualPhysicalPrefixFields
import Navier.Construction.ActualStageEstimates
import Navier.Construction.ActualSignedExterior
import Navier.Construction.ActualCurrentParticularAssembly
import Navier.Construction.GluedStageEstimates
import Navier.Construction.ActualSignedWaveData
import Navier.Construction.CurrentSignedCurl
import Navier.Construction.ActualSignedPhysicalCoherence
import Navier.Construction.GermEndpointInputs
...
namespace Navier.Construction.ActualCandidateAssembly
...
theorem initialPotential_exterior (B N0 : ℕ) {w : SpaceTime}
  ...
  have hx : InitialPhysicalData.physicalX w ∉
    ...
    simpa only [InitialPhysicalData.physicalX, physicalRadiusX_eq,
      ActualPolarCoverage.active, Set.mem_setOf_eq] using he
  change InitialPhysicalData.potential B N0 w +
...
end Navier.Construction.ActualCandidateAssembly
