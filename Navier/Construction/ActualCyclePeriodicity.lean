...
Upstream source: NavierStokes/ActualCyclePeriodicity.lean
...
import Navier.Construction.ActualSeedPeriodicity
import Navier.Construction.ActualWaveCoefficientPeriodicity
...
namespace Navier.Construction.ActualCyclePeriodicity
...
theorem constant {f : D → ℂ} (hf : TranslationOn U v f) :
  ...
  rw [hc, hc]
  by_cases hj : (0 : ℤ) = j
  · rw [if_pos hj, if_pos hj, hf x hx]
...
end Navier.Construction.ActualCyclePeriodicity
