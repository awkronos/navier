...
Upstream source: NavierStokes/ExtendedHeatedOutgoing.lean
...
import Navier.Construction.ExtendedHeatDebts
...
open Navier.Construction.OutgoingProfile (Profile)
open Navier.Construction.OutgoingDilation (switchRadius patchRadius patchRatio compensationPatch shapedPatchAmplitude)

namespace Navier.Construction.ExtendedHeatedOutgoing
...
theorem ScheduleBounds.physicalBand_subset {F : Profile} (b : ScheduleBounds F) :
  ...
  intro eta heta
  exact ⟨Navier.Construction.ExtendedHeatedOutgoing.physicalBand_subset heta,
...
end Navier.Construction.ExtendedHeatedOutgoing
