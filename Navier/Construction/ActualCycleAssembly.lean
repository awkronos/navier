...
Upstream source: NavierStokes/ActualCycleAssembly.lean
...
import Navier.Construction.ActualCarrierTransport
...
namespace Navier.Construction.ActualCycleAssembly
...
theorem refined_carrier_factorization (hN : ActualCarrierGeometry.geometricThreshold ≤ N0)
  ...
  simp only [ActualCarrierTransport.canonicalSourceRegion, ActualGaussianCoverage.sourceRegion,
    refinedSlowCore, mem_inter_iff, mem_preimage, Set.mem_setOf_eq]
  tauto
...
end Navier.Construction.ActualCycleAssembly
