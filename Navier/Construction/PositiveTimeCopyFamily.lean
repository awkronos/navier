...
Upstream source: NavierStokes/PositiveTimeCopyFamily.lean
...
namespace Navier.Construction.PositiveTimeCopyFamily
...
theorem term_eq (I : WaveIndex H) (k : K) {w : SpaceTime} (hw : w ∈ preterminal) :
  ...
  simp only [CopyFamily.term, CopyFamily.copy, PhysicalWaveSum.WaveFamily.term,
    PhysicalWaveSum.globalWave, PhysicalWaveSum.commonWave, gate, if_pos hl]
...
end Navier.Construction.PositiveTimeCopyFamily
