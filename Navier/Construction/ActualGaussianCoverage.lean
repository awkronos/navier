...
Upstream source: NavierStokes/ActualGaussianCoverage.lean
...
import Navier.Construction.LocalizedGaussianBounds
...
namespace Navier.Construction.ActualGaussianCoverage
...
theorem referenceP_scaled_bound {lam u L c : ℝ}
  ...
  rw [GaussianTailFlat.referenceSlotEnvelope, if_pos htheta] at hb
...
end Navier.Construction.ActualGaussianCoverage
