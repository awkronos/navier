...
Upstream source: NavierStokes/CorrectionStep.lean
...
-/
import Navier.Construction.LabelSupportPreservation
import Navier.Construction.HarmonicStructurePreservation
import Navier.Construction.LocalResidualGrouping
import Navier.Construction.AxisymmetricResidualGrouping
import Navier.Construction.MeanBoundsReindex
import Navier.Construction.MeanStageRegularity
import Navier.Construction.WaveStateRegularity
import Navier.Construction.MeanStateRegularity
import Navier.Construction.BandReindexedSignedMeanGain
import Navier.Construction.PhysicalResidualNaturality
import Navier.Construction.UniformBlockBounds
import Navier.Construction.UniformHarmonicInteraction
import Navier.Construction.LocalizedCurlRealization
import Navier.Construction.LocalizedMeanInteraction
import Navier.Construction.HarmonicSourceSupport
import Navier.Construction.NativePrincipalEquations
import Navier.Construction.ParticularCopyBounds
import Navier.Construction.SignedCopyBounds
import Navier.Construction.LocalizedWaveBounds
import Navier.Construction.MovingMomentBounds
import Navier.Construction.GaugeDebtIncrement
import Navier.Construction.GaugeMassPreservation
import Navier.Construction.RankStateBounds
import Navier.Construction.SignedMeanGain
import Navier.Construction.PeriodizedWaveBounds
import Navier.Construction.MeanIncrementBounds
import Navier.Construction.HarmonicFields
import Navier.Construction.ExponentLedger
import Navier.Construction.CorrectionState
import Navier.Construction.LinearWaveResidual
import Navier.Construction.DefectIncrementBounds
import Navier.Construction.HarmonicResidual
import Navier.Construction.LiftedMeanResidual
import Navier.Construction.MeanChartCompatibility
import Navier.Construction.HarmonicCovariance
import Navier.Construction.HarmonicMeanInteraction
import Navier.Construction.PhysicalMeanDomain
import Navier.Construction.SignedWaveUpdate
import Navier.Construction.VariableGaugeMean
import Navier.Construction.PhysicalResidualBridge
import Navier.Construction.LabelSumBounds
...
import Navier.Construction.LocalRankDefect
...
namespace Navier.Construction.CorrectionStep
...
theorem SignedParameters.Dynamics.linearGood_bounds
  ...
  · intro i j hj
    have hz (x : D) : (HarmonicFields.constantCoefficient (fun _ : D => (0 : ℂ))).coeff j x = 0 := by
      change (Finsupp.single (0 : ℤ) (0 : D → ℂ)) j x = 0
      simp
    simpa [zero, ErrorHarmonics.zeroBlock, hz] using hcancel i j hj
  · intro n x hx θ i
...
theorem NativeDynamics.linearGood_bounds (hκ : κ ≤ 1 / 2)
  ...
  · intro i j hj
    have hz (x : D) : (HarmonicFields.constantCoefficient (fun _ : D => (0 : ℂ))).coeff j x = 0 := by
      change (Finsupp.single (0 : ℤ) (0 : D → ℂ)) j x = 0
      simp
    simpa [zero, ErrorHarmonics.zeroBlock, hz] using hc i j hj
  · intro n x hx θ i
...
theorem uniform_linearGood_bounds
  ...
  · intro i j hj
    have hz (x : D) : (HarmonicFields.constantCoefficient (fun _ : D => (0 : ℂ))).coeff j x = 0 := by
      change (Finsupp.single (0 : ℤ) (0 : D → ℂ)) j x = 0
      simp
    simpa [z, ErrorHarmonics.zeroBlock, hz] using he i j hj
  · intro l n x hx θ i
...
end Navier.Construction.CorrectionStep
