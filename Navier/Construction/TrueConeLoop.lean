...
Upstream source: NavierStokes/TrueConeLoop.lean
...
-/
import Navier.Construction.LoopVariance
...
namespace Navier.Construction.TrueConeLoop
...
theorem familyDensity_eq (a m p : E → ℝ) (d δ : ℝ) (hd : d ≠ 0) (hδ : 0 < δ)
  ...
  simp only [familyDensity, dif_pos hx]
...
end Navier.Construction.TrueConeLoop
