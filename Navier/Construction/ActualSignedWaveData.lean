...
Upstream source: NavierStokes/ActualSignedWaveData.lean
...
import Navier.Construction.ActualSignedNativeProfiles
import Navier.Construction.ActualPhaseJetBounds
import Navier.Construction.PositiveTimeCopyFamily
import Navier.Construction.PositiveTimeSignedData
import Navier.Construction.ActualSignedReferenceGeometry
import Navier.Construction.ActualSignedFamilySupport
import Navier.Construction.ActualSignedNativeRegularity
import Navier.Construction.ActualSignedNativeBounds
...
namespace Navier.Construction.ActualSignedWaveData
...
private theorem branchCells_active (f : DependentSignedPhysicalFamily.Family)
  ...
  classical
  simp only [DependentSignedPhysicalFamily.Family.branchCells, dif_pos L.mem]
...
private theorem branchCells_inactive (f : DependentSignedPhysicalFamily.Family)
  ...
  classical
  simp only [DependentSignedPhysicalFamily.Family.branchCells, dif_neg hL]
...
end Navier.Construction.ActualSignedWaveData
