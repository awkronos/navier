...
Upstream source: NavierStokes/ValidBandGluing.lean
...
namespace Navier.Construction.ValidBandGluing
...
theorem representative_zero [Zero E] {U : ι → Set D} {f : ι → D → E}
  ...
  simp only [representative, dif_neg hn]
...
end Navier.Construction.ValidBandGluing
