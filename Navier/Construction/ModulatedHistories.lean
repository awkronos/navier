...
Upstream source: NavierStokes/ModulatedHistories.lean
...
namespace Navier.Construction.ModulatedHistories
...
theorem localized_density_difference (W : Window)
  ...
  · simp only [localizedF, localizedU, density, splice, hX, if_pos, indicator_of_mem,
...
end Navier.Construction.ModulatedHistories
