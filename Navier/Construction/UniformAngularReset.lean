...
Upstream source: NavierStokes/UniformAngularReset.lean
...
-/
import Navier.Construction.AngularMomentReset
import Navier.Construction.OutgoingTail
import Navier.Construction.ParametricFlatFactor
...
open Navier.Construction.AngularMomentReset

namespace Navier.Construction.UniformAngularReset
...
theorem exists_smooth_solver_on_ball [FiniteDimensional ℝ E] [CompleteSpace E]
  ...
  have hspec : ∀ d (hd : d ∈ Metric.ball (0 : E) ε),
    ...
    intro d hd
    simpa only [g, dif_pos hd] using hf ⟨d, hd⟩
...
end Navier.Construction.UniformAngularReset
