...
Upstream source: NavierStokes/VolterraAnalyticBounds.lean
...
namespace Navier.Construction.VolterraAnalyticBounds
...
theorem RadialBound.radialInverse {F : Field} {T ρ B : ℝ} {c : ℂ} {k : ℕ}
  ...
  have hi := intervalIntegral.norm_integral_le_abs_of_norm_le hbe
    ((continuous_const.fun_mul (continuous_id.pow k)).intervalIntegrable (0 : ℝ) 1)
...
end Navier.Construction.VolterraAnalyticBounds
