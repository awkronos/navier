...
Upstream source: NavierStokes/PhysicalMeanDomain.lean
...
namespace Navier.Construction.PhysicalMeanDomain
...
theorem normalizedDomain_eq (coord qlo qhi rlo rhi : ℝ) :
  ...
  ext p
  simp only [MeanRankUpdate.normalizedDomain, stripDomain, normalizedSlowDomain, Set.mem_setOf_eq,
...
end Navier.Construction.PhysicalMeanDomain
