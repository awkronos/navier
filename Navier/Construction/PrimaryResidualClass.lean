...
Upstream source: NavierStokes/PrimaryResidualClass.lean
...
namespace Navier.Construction.PrimaryResidualClass
...
theorem initial_residual_class_of_zero_mode (u : CorrectionState.State D)
  ...
  rw [HarmonicMeanInteraction.constantCoefficient_coeff, if_neg hj]
...
end Navier.Construction.PrimaryResidualClass
