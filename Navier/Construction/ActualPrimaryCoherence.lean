...
Upstream source: NavierStokes/ActualPrimaryCoherence.lean
...
namespace Navier.Construction.ActualPrimaryCoherence
...
theorem globalPotential_forward {a : ℝ} (ha : 0 < a)
  ...
  · have hn : ‖PolarCharts.polar (z.2 0,z.2 1)‖ ≤ a/4 := by
    ...
    rw [PhysicalCurlCovariance.globalCartesianPotential,dif_neg hc',hzero z hz]
...
end Navier.Construction.ActualPrimaryCoherence
