...
Upstream source: NavierStokes/VariableGaugeMean.lean
...
namespace Navier.Construction.VariableGaugeMean
...
theorem fderiv_apply_supportedGauge {a b : ℝ} {ell : S → ℝ} {U : Set S}
  ...
  change fderiv ℝ f z (w z) = 0 at he
  exact hn he
...
end Navier.Construction.VariableGaugeMean
