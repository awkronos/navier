...
Upstream source: NavierStokes/WaveEnvelopeTransport.lean
...
namespace Navier.Construction.WaveEnvelopeTransport
...
theorem grouped_path_zero_of_transverse_support {g : Geometry} {r L : ℝ}
  ...
  exact hξT (by simpa only [Set.mem_setOf_eq, path_transverse] using hh)
...
end Navier.Construction.WaveEnvelopeTransport
