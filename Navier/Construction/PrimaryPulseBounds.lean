...
Upstream source: NavierStokes/PrimaryPulseBounds.lean
...
-/
import Navier.Construction.PhaseJetBounds
import Navier.Construction.WeightedClasses
import Navier.Construction.WeightedQuotients
import Navier.Construction.PartitionedCovariance
import Navier.Construction.JointODE
import Navier.Construction.CurlClassBounds
import Navier.Construction.SignedCovariance
import Navier.Construction.GaussianTailFlat
...
namespace Navier.Construction.PrimaryPulseBounds
...
theorem cutoffPulse_envelope_jets
  ...
  have hp' := hp.mono_weight (v := fun i z =>
    ...
    intro i z hz
    rw [GaussianTailFlat.referenceSlotEnvelope, if_pos ⟨hz.2.1.le, hz.2.2.le⟩]
    rfl)
  apply hp'.localize
...
end Navier.Construction.PrimaryPulseBounds
