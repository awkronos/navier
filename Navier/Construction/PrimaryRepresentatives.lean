...
Upstream source: NavierStokes/PrimaryRepresentatives.lean
...
namespace Navier.Construction.PrimaryRepresentatives
...
theorem gridBox_closed (n : ℕ) (k : Grid) (a : ℝ) : IsClosed (gridBox n k a) := by
  simp only [gridBox, Set.setOf_forall]
...
end Navier.Construction.PrimaryRepresentatives
