...
Upstream source: NavierStokes/PhysicalWaveSum.lean
...
namespace Navier.Construction.PhysicalWaveSum
...
theorem chooseChart_valid {a b : ℝ} (ha : 0 < a) {x : Plane}
  ...
  simp only [chooseChart, dif_pos he]
...
end Navier.Construction.PhysicalWaveSum
