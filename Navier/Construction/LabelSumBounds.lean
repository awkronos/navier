...
Upstream source: NavierStokes/LabelSumBounds.lean
...
namespace Navier.Construction.LabelSumBounds
...
theorem physicalBox_closed (d : ℝ) (l : SlotColoring.Label) :
  ...
  have he : SlotColoring.physicalBox d l = ⋂ j : Fin 3,
    ...
    ext x
    simp only [SlotColoring.physicalBox, Set.mem_setOf_eq, mem_iInter]
  rw [he]
...
end Navier.Construction.LabelSumBounds
