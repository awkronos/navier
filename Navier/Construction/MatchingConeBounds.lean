...
Upstream source: NavierStokes/MatchingConeBounds.lean
...
namespace Navier.Construction.MatchingConeBounds
...
theorem profiles_before_restore (hsep : c.separation ≤ Real.exp (-8))
  ...
  · change c.f p = _
    rw [NominalProfile.Controls.f, if_neg hi, hE]
...
end Navier.Construction.MatchingConeBounds
