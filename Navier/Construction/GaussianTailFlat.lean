...
Upstream source: NavierStokes/GaussianTailFlat.lean
...
import Navier.Construction.WeightedRadialPrimitive
...
namespace Navier.Construction.GaussianTailFlat
...
theorem referenceSlotEnvelope_bound {lam u L : ℝ}
  ...
  · rw [referenceSlotEnvelope, if_pos hθ]
    ...
    congr 1
    field_simp [hL.ne']
  · rw [referenceSlotEnvelope, if_neg hθ]
...
end Navier.Construction.GaussianTailFlat
