...
Upstream source: NavierStokes/SignedWaveUpdate.lean
...
import Navier.Construction.SignedStressPrimitive
...
import Navier.Construction.MeanMomentBounds
...
namespace Navier.Construction.SignedWaveUpdate
...
theorem conjugatePair_apply (a : D → ℂ) (j : ℤ) (x : D) :
  ...
  classical
  let c : HarmonicFields.Coefficients D :=
    AddMonoidAlgebra.single (1 : ℤ) (fun x => a x / 2)
  change (c + HarmonicFields.conjugateReverse c).coeff j x = _
...
end Navier.Construction.SignedWaveUpdate
