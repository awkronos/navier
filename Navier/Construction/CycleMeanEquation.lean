...
Upstream source: NavierStokes/CycleMeanEquation.lean
...
namespace Navier.Construction.CycleMeanEquation
...
theorem block_divergence_zero {s : WeightedClasses.StripData D} {c : Context D}
  ...
  have hc (j : ℤ) : divergenceCoefficients g (b.frequency n) (b.phase n)
    ...
    change (AddMonoidAlgebra.single j
      (divergenceCoefficients g (b.frequency n) (b.phase n)
        (b.angularFrequency n) (blockAmplitude b n) j) : Coefficients _).coeff j x.1 = _ at hs
    rw [if_pos rfl] at hs
    rw [hs] at he
    exact he
...
end Navier.Construction.CycleMeanEquation
