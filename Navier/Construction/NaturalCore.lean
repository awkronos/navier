...
Upstream source: NavierStokes/NaturalCore.lean
...
import Navier.Construction.BlowupImplication
...
namespace Navier.Construction.NaturalCore
...
theorem core_axis_mem (h Λ : ℝ)
  ...
  simpa only [coreDomain, Set.mem_setOf_eq, profilePoint, radialEnergy, PiLp.zero_apply,
...
end Navier.Construction.NaturalCore
